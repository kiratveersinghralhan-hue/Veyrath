/* Public Supabase project settings. The anon/publishable key is safe in a browser only with RLS enabled.
   If admin magic links open the wrong Supabase project, replace BOTH values below with the VEYRATH project's
